...
#if !defined(MGPT_ESP32C6)
#error "ESP32-C6 profile marker is required"
#endif
#if !defined(__riscv) || defined(__arm__)
#error "ESP32-C6 model lane did not compile as RISC-V"
#endif
#if !defined(__riscv_xlen) || (__riscv_xlen != 32)
#error "ESP32-C6 model lane did not compile as RV32"
#endif
#if defined(__riscv_flen)
#error "ESP32-C6 model lane unexpectedly enables an FP extension"
#endif
...
static void run_once(void) {
    ...
    bool negative = true;
    Serial.println("ESP32C6_F12 schema=full_v1 board=esp32-c6 "
                   "arch=rv32imac isa_fpu=none clock_hz=160000000");
    ...
    Serial.print("ESP32C6_F12_RESULT correctness=");
