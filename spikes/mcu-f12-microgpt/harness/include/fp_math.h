 ...
 *   Lineage of this fixed-point implementation:
 ...
 *   `make test` checks that the native and forced-portable host fixtures
 *   reproduce the same pinned transcript.
 */
...
static inline fixed_t fp_inv_sqrt(fixed_t x) {
     ...
     * caught by the cross-backend regression tests run by `make test`.)
     *
