...
#if !defined(MGPT_MKRZERO)
#error "MKR Zero profile marker is required"
#endif
#if !defined(__arm__) || defined(__riscv)
#error "MKR Zero model lane did not compile as ARM"
#endif
#if !defined(__ARM_ARCH_6M__)
#error "MKR Zero model lane did not compile as Armv6-M"
#endif
#if defined(__ARM_FP) && (__ARM_FP != 0)
#error "MKR Zero model lane unexpectedly enables an FP architecture"
#endif
...
static void run_once(void) {
    ...
    bool negative = true;
    Serial.println("MKRZERO_F12 schema=full_v1 board=mkrzero "
                   "arch=cortex-m0plus isa_fpu=none clock_hz=48000000");
    ...
    Serial.print("MKRZERO_F12_RESULT correctness=");
